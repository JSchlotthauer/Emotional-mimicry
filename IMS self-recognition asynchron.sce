...
scenario = "IMS self-recognition asynchron";
...
# Presentation of instructions I
trial {
  ...
  picture {
	...
	code = "INS. I";
} instructions_exp1; # Name of the object
...
# Transformation task I
trial {
	trial_type = first_response; # The trial ends with the first pressing of the designated button
	trial_duration = stimuli_length; # or until the video ends 
   video { 
		filename = "v02.avi"; # Video file to be presented
		description = "Transformation task I";};
	picture {};
	port_code = 60; # Designated port code sent to the EEG recorder
	code = "Transformation task I"; # Designated code for the analysis window
} trans_task1;

# Transformation task II
trial {
	trial_type = first_response; # The trial ends with the first pressing of the designated button
	trial_duration = stimuli_length; # or until the video ends 
   video { 
		filename = "v02.avi"; # Video file to be presented
		description = "Transformation task II";};
	picture {};
	port_code = 70; # Designated port code sent to the EEG recorder
	code = "Transformation task II"; # Designated code for the analysis window
} trans_task2;
...
trial {
   video { 
	...
	picture {};
	port_code = 50; # Port code sent to the EEG recorder
	code = "IMS asynchron"; # Code in the Analysis Window
} IMS_asyn;
...
# Presentation of instructions IV
trial {
	trial_type = first_response; # Awaits for response
	trial_duration = forever; # Lasts until a response is given
  picture {
	...
	code = "INS. IV";
} instructions_exp4; # Name of the object
